...
add_action( 'widgets_init', create_function( '', 'return register_widget( "metro_flickr_widget" );' ) );

class metro_flickr_widget extends WP_Widget{
    
    function metro_flickr_widget() {
        $widget_ops = array( 'classname' => 'mt-flickr', 'description' => __( 'Display your latest Flickr photos', 'applause' ) );
        $control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'mt-flickr' );
        $this->WP_Widget( 'mt-flickr', __( 'Metro Flickr Photos', 'applause' ), $widget_ops, $control_ops );
    }
...
<?php
    ...
    function form( $instance ){
        $defaults = array(
            'title'        => __( 'Flickr Photos', 'applause' ),
            'flickr_id'    => '',
            'flickr_count' => 4,
        );
        ...
        <p>
            <label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e( 'Your Flickr User ID:', 'applause' ); ?></label>
            ...
            <span class="description"><?php echo sprintf( __( 'Head over to %s to find your Flickr user ID.', 'applause' ), '<a href="//idgettr.com" target="_blank" rel="nofollow">idgettr</a>' ); ?></span>
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('flickr_count'); ?>"><?php _e( 'Number of photos to show:', 'applause' ); ?></label>
